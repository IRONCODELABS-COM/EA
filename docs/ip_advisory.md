---
layout: default
title: DBJ Method IP Explainer
description: DBJ Method IP Explainer
---
- [Advisory on the DBJ.METHOD IP rights](#advisory-on-the-dbjmethod-ip-rights)
  ...
  - [Commercial License — the alternative path](#commercial-license--the-alternative-path)
...
> 
> A **commercial license** is available from DBJ for Users who require closed-source or proprietary distribution rights. Contact: [dbj@dbj.org](mailto:dbj@dbj.org)
...
## User rights and obligations under CC BY SA 4.0

Under CC BY SA 4.0, any User must do three things:

1. **Attribution — on every use**  
...
3. **ShareAlike — on any adaptation**  
...
- No permission from DBJ is required to use it
- No royalties are due
- The User can charge customers for training that uses the material
- The User does not need to share their internal business processes — only the derived methodology content itself falls under ShareAlike

## Practical risk for the User
...
## Commercial License — the alternative path
...
- Incorporating DBJ Method into proprietary products
- Releasing derivative material as closed source
- Selling it without attribution or reciprocity obligations
...
- Use DBJ Method commercially ✓
- Charge customers for training that incorporates it ✓
- Build services around it ✓
- All without negotiating anything, under CC BY SA 4.0 as-is.
