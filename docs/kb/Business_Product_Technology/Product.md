...
- **Data models** — Logical data structures that support the declared product
- **Physical specifications** — platform, hosting, and deployment constraints the product must satisfy
