...
- **Reasoning** — logic under uncertainty, not pattern completion
- **Planning** — long-term goal-setting with self-directed steps
- **Learning from experience** — real-time adaptation from its own mistakes
- **Common sense** — the unwritten rules of the physical and social world
- **Transfer learning** — applying knowledge from one domain to a structurally different one
