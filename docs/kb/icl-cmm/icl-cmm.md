...
![ICLCMM](togaf_cmm_icl_simplified.png)
...
An organization at L3 across all five elements has what the [ICL ADM](https://ea.ironcodelabs.com/kb/icl-adm/icl_adm.html) requires to function:
...
- **Projects / Portfolios** can run a structured five-step [ICL ADM](https://ea.ironcodelabs.com/kb/icl-adm/icl_adm.html) wheel
...
Below L3, one or more of these conditions fails — and the [ICL ADM](https://ea.ironcodelabs.com/kb/icl-adm/icl_adm.html) wheel stalls.
