...
1. **Architecture Characteristics of Processes at Different Maturity Levels**: The nine architecture characteristics provide a comprehensive view of an organisation’s architecture capabilities. These include architectural process, architectural development, business linkage, senior management involvement, operating unit participation, architectural communication, Technology3 security, architectural governance, and Technology3 investment and acquisition strategy.
1. **The ACMM Scorecard**: The ACMM scorecard acts as a monitoring and assessment tool. It allows organisations to gauge their current maturity level in each of the nine characteristics, enabling a clear understanding of strengths, weaknesses, and areas for improvement.
...
1. **Architecture Development** — maturity of producing architecture artefacts and deliverables
1. **Business Linkage** — alignment between architecture and business strategy/goals
1. **Senior Management Involvement** — executive sponsorship and engagement with EA
1. **Operating Unit Participation** — involvement of business units in architecture processes
1. **Architecture Communication** — how architecture is communicated across the organisation
1. **IT Security** — integration of security into architecture practice
1. **Architecture Governance** — controls, compliance, decision-making structures
1. **IT Investment and Acquisition Strategy** — how architecture informs technology investment decisions
